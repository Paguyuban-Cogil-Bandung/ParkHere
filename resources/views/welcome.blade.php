...
<body class="{{ $class ?? '' }}">
                ...
                <nav
                    ...
                    <div class="container-fluid">
                        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="{{ route('welcome') }}">
                            <img src="{{ asset('/assets') }}/guest/images/Logo.png" class="img-fluid"
                                style="height: 2em;" alt="main_logo">
                        </a>
                            ...
                            <ul class="navbar-nav d-sm-block sm-mb-2">
                                @if (Auth::check() == true)
                                    @if (Auth::user()->usertype == 'admin')
                                        <a href="{{ route('admin.dashboard') }}"
                                            class="btn btn-sm mb-0 me-1 btn-primary">Dashboard</a>
                                ...
                                @else
                                    <li class="nav-item d-flex justify-content-center">
                                        <a href="{{ route('login') }}"
                                            class="btn btn-sm mb-0 me-1 btn-primary-outline">Login</a>
                                        <a href="{{ route('register') }}"
                                            class="btn btn-sm mb-0 me-1 btn-primary">Register</a>
                                    </li>
                                @endif
                            </ul>
                        </div>
    ...
    <main class="main-content  mt-0">
        <div class="hero-wrap ftco-degree-bg"
            style="background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.5)), url('{{ asset('/assets') }}/guest/images/bg-orange.jpg') no-repeat center center/cover;">
            <div class="container">
                <div
                    class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
                    <div class="col-lg-8 ftco-animate">
                        <div class="text w-100 text-center mt-5 mt-md-0">
                            <!-- Teks untuk desktop -->
                            <h1 class="mb-4 d-none d-md-block">Temukan Tempat Parkir dengan Mudah dan Cepat!</h1>
                            <!-- Teks untuk mobile -->
                            <h1 class="mb-4 d-block d-md-none fs-1">Temukan Tempat Parkir dengan Mudah dan Cepat!</h1>
                            <p style="font-size: 18px;">ParkHere adalah solusi pintar untuk menemukan dan memesan
                                tempat parkir terdekat. Hemat waktu, hindari stres, dan nikmati pengalaman parkir tanpa
                                ribet</p>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="services-wrap rounded-right w-100">
                                    ...
                                    <div class="row d-flex mb-4">
                                        <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                                            <div class="services w-100 text-center">
                                                ...
                                                <div class="text w-100">
                                                    <h3 class="heading mb-2">Tempat Parkir Rekomendasi Terdekat Dengan
                                                        Anda</h3>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                                            <div class="services w-100 text-center">
                                                <div class="icon d-flex align-items-center justify-content-center">
                                                    <span class="fa-solid fa-shield-halved"></span></div>
                                                <div class="text w-100">
                                    ...
                                    <p><a href="{{ route('dashboard') }}"
                                            class="btn btn-primary py-3 px-4 d-flex justify-content-center">Cari Tempat
                                            Parkir Sekarang</a></p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center"
                        style="background-image: url({{ asset('/assets') }}/guest/images/about.jpg);">
                    </div>
                    <div class="col-md-6 wrap-about ftco-animate">
                        <div class="heading-section heading-section-white pl-md-5">
                            ...
                            <p>Di ParkHere, kami berkomitmen untuk menyediakan solusi parkir yang mudah, aman, dan
                                efisien. Dengan teknologi canggih dan sistem yang user-friendly, kami membantu Anda
                                menemukan tempat parkir dengan cepat di lokasi strategis. Kami memahami betapa berharga
                                waktu Anda, sehingga kami memudahkan Anda untuk memesan tempat parkir melalui aplikasi
                                kami, memastikan Anda selalu mendapatkan tempat parkir yang nyaman dan terjamin
                                keamanannya.</p>
                            <p>Visi Kami adalah untuk menjadi layanan parkir terdepan yang menawarkan kenyamanan,
                                kemudahan, dan keandalan di setiap perjalanan Anda. Dengan keamanan 24 jam, akses cepat,
                                dan harga yang kompetitif, ParkHere memastikan pengalaman parkir yang bebas stres bagi
                                Anda, kapan saja dan di mana saja.</p>
                            <p>Bergabunglah dengan kami dan nikmati pengalaman parkir yang lebih praktis, tanpa khawatir
                                tentang kesulitan mencari tempat parkir!</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="item">
                                <div class="car-wrap rounded ftco-animate">
                                    <div class="img rounded d-flex align-items-end"
                                        style="background-image: url({{ asset('/assets') }}/guest/images/parkir1.jpeg);">
                                    </div>
                                    <div class="text">
                                        ...
                                        <p class="d-flex mb-0 d-block"><a href="#"
                                                class="btn btn-primary py-2 mr-1 w-100">Lihat Lokasi Parkir</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="services services-2 w-100 text-center">
                            <div class="icon d-flex align-items-center justify-content-center"><span
                                    class="fa-solid fa-shield-halved"></span></div>
                            <div class="text w-100">
        ...
        <section class="ftco-section ftco-intro" id="kontak"
            style="background-image: url({{ asset('/assets') }}/guest/images/bg_3.jpg);">
                    ...
                    <div class="col-md-12">
                        <div class="carousel-testimony owl-carousel ftco-owl">
                            <div class="item">
                                <div class="testimony-wrap rounded text-center py-4 pb-5">
                                    <div class="user-img mb-2"
                                        style="background-image: url({{ asset('/assets') }}/guest/images/person_1.jpg)">
                                    </div>
                                    <div class="text pt-4">
                                        <p class="mb-4">ParkHere benar-benar memudahkan saya dalam mencari tempat
                                            parkir. Dengan aplikasi ini, saya tidak perlu lagi khawatir mencari parkir
                                            di area yang ramai. Cukup beberapa klik, tempat parkir sudah terjamin!
                                            Sangat membantu, terutama saat saya sedang terburu-buru.</p>
                            ...
                            <div class="item">
                                <div class="testimony-wrap rounded text-center py-4 pb-5">
                                    <div class="user-img mb-2"
                                        style="background-image: url({{ asset('/assets') }}/guest/images/person_2.jpg)">
                                    </div>
                                    <div class="text pt-4">
                                        <p class="mb-4">Layanan parkir ParkHere sangat nyaman dan aman. Saya merasa
                                            lebih tenang karena ada sistem keamanan 24 jam. Selain itu, aplikasi
                                            ParkHere sangat mudah digunakan, dan saya bisa memesan tempat parkir jauh
                                            sebelum tiba di lokasi.</p>
                                        <p class="name">Roger Scott</p>
                            ...
                            <div class="item">
                                <div class="testimony-wrap rounded text-center py-4 pb-5">
                                    <div class="user-img mb-2"
                                        style="background-image: url({{ asset('/assets') }}/guest/images/person_3.jpg)">
                                    </div>
                                    <div class="text pt-4">
                                        <p class="mb-4">Sebagai orang yang sering bepergian ke berbagai tempat,
                                            ParkHere telah menghemat waktu saya. Aplikasi ini memungkinkan saya untuk
                                            memesan parkir lebih dulu, jadi saya tidak perlu pusing lagi mencari tempat
                                            parkir. Keamanan dan kenyamanannya sangat terjaga dan terjamin.</p>
                                        <p class="name">Roger Scott</p>
                                        <span class="position">Pengguna ParkHere</span>
                                    </div>
                                </div>
                ...
                <div class="row mb-5">
                    <div class="col-md">
                        <div class="ftco-footer-widget mb-4">
                            <h2 class="ftco-heading-2 text-center"><img
                                    src="{{ asset('/assets') }}/guest/images/Logo-footer.png" class="rounded"
                                    style="width:17em"></h2>
                            <p>ParkHere adalah solusi pintar untuk menemukan dan memesan tempat parkir terdekat. Hemat
                                waktu, hindari stres, dan nikmati pengalaman parkir tanpa ribet</p>
                    ...
                    <div class="col-md">
                        <div class="ftco-footer-widget mb-4">
                            ...
                            <div class="block-23 mb-3">
                                <ul>
                                    <li><span class="icon icon-map-marker"></span><span class="text">Jl. Dipati Ukur
                                            No.112-116, Lebakgede, Kecamatan Coblong, Kota Bandung, Jawa Barat
                                            40132</span></li>
                                    <li><a href="#"><span class="icon icon-phone"></span><span
                                                class="text">+62 392 3929 210</span></a></li>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            ...
                            </script> All rights reserved | ParkHere Company
